...
$(document).ready(function () {
    ...
    document.getElementById('oth'), document.getElementById('afa-price2'), document.getElementById('adp'),
    document.getElementById('interest-price')
        ...
        element.addEventListener('change', function () {
            ...
            document.getElementById('taxb-price').textContent = f(parseInt((we)));
...
function benefit() {
    ...
    var p = document.getElementById("taxb-price").textContent;
