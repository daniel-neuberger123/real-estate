...
$(document).ready(function () {
    ...
    p1.textContent = "Der Immo Rechner wurde mit größter Sorgfalt konzipiert und wird Ihnen kostenfrei aber auf eigenes Risiko zur Verfügung gestellt. Der Immo Rechner stellt lediglich eine Beispiels¬wert-entwicklung einer Immobilie auf Basis der durch Sie eingegeben Daten dar, ohne dass das Rechenergebnis zu einer Immobilien¬wert¬entwicklung als die Realität abbildbar und/oder als verlässlich zu erachten ist. Das ermittelte Ergebnis des Immo Rechners dient lediglich als nicht belastbare Orientierungs¬hilfe und als erster Anhaltspunkt für Sie und ersetzt insbesondere keine fachgerechte Beratung zu einer";
    q1.textContent = "Immobilien¬investition. Der Immo Rechner und die Rechener¬gebnisse zu einer Immobilien¬wert¬entwicklung sind daher auch ausdrücklich nicht als persönliche Anlageberatung zu verstehen. Die Grauhirsch Immobilien GmbH übernimmt ausdrücklich auch keine Haftung für die Richtigkeit der Berechnung des Immo Rechners und dessen ermittelte Wert¬entwicklungs¬ergebnisse und des tatsächlichen Eintritts der ermittelten Immobilien¬wert¬entwicklung und übernimmt daher auch keine Haftung, sofern Sie Ihre Entscheidung über eine Immobilien¬investition auf Basis des Wert¬entwicklungs¬ergebnisses des Immo Rechners treffen. Ferner gilt: Die weitere Nutzung der";
    l1.textContent = "Wert¬ermittlungs¬ergebnisse obliegt ausschließlich Ihnen als Anwender.Insofern gilt dieser Haftungsausschluss auch gegenüber Dritten.";
